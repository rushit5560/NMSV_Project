...
import 'package:nmsv_project/screens/auth_screens/forgot_password_screen/forgot_password_screen_widgets.dart';
...
class ForgotPasswordScreen extends StatelessWidget {
  ...
  final forgotPasswordScreenContoller =
      Get.put(ForgotPasswordScreenContoller());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: customAppBar(
        ...
        leadingOnTap: () {},
        titleText: AppMessage.forGotPassword,
      ),
